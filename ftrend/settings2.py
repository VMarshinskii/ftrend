"""
Django settings for ftrend project.
...
SECRET_KEY = '#yj95(=x-6a+a(k%2y^kbl@_ra7(_=^zwp-ze&jm-957i_4xm2'
...
ROOT_URLCONF = 'ftrend.urls'

WSGI_APPLICATION = 'ftrend.wsgi.application'
